A smart fruit recommendation web application built using Python and Streamlit that suggests fruits with similar nutritional values using a Content-Based Recommendation System powered by Cosine Similarity.
